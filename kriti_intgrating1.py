...
while(1):
	...
	#print "i am at 2"	
	lower_bound=np.array([0,2,232])
	upper_bound=np.array([179,117,255])

	lower_boundb=np.array([8,183,120])
	upper_boundb=np.array([20,255,188])
	#print "i am at 3"
